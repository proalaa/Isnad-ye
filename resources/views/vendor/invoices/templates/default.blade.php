            ...
            <tbody>
                <tr>
                    ...
                    <td class="border-0 pl-0">
                        <p style="direction: rtl"><strong>{{ $invoice->getSerialNumber() }}</strong> {{ __('invoices::invoice.serial') }}: </p>
                        <p><strong>{{ $invoice->getDate() }}</strong>{{ __('invoices::invoice.date') }} : </p>
                    </td>
                </tr>
            </tbody>
        </table>
                ...
                <tr>
                    <td class="px-0">
                        ...
                        @if($invoice->seller->address)
                            <p class="seller-address" style="direction: rtl">
